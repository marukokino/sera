...
describe "mercadoria/new" do
  before(:each) do
    assign(:mercadorium, stub_model(Mercadorium,
      :nome => "MyString",
      :descricao => "MyText",
      :preco => 1,
      :precoumcbm => 1,
  ...
  it "renders new mercadorium form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", mercadoria_path, "post" do
